...
export const generateContent = async (req, res) => {
  try {
    ...
    // Add this validation right before saving the content
if (!generatedContent.content || generatedContent.content.trim() === '') {
  console.error('Empty content generated by AI:', generatedContent);
  return res.status(400).json({
    success: false,
    message: 'AI generated empty content. Please try again with different parameters.'
  });
}

// Also add enum validation
